...
class Face_recognition:
    def __init__(self,root):
        ...
        title_lbl = Label(self.root, text='FACE RICOGNITION', font=('times new roman',35,'bold'),bg='white',fg='green')
        ...
        f_lbl.place(x=0, y=45, width=700, height=600)
        ...
        f_lbl.place(x=700, y=45, width=700, height=600)
        ...
        b1_1.place(x=235,y=530,width=220,height=35)
